...
$FILENAME =~ s/\s/_/g;
my $COVER_FULL  = 'cover_full.png';
my $COVER_THUMB = 'cover_thumb.png';
...
sub generate_ebook
{
    ...
    # Add the book cover.
    add_cover($epub, "./images/$COVER_FULL");
    ...
    my $filename = catfile('build', 'epub', "$FILENAME.epub");
...
sub add_cover
{
    ...
    my $cover_id = $epub->copy_image($cover_image, "images/$COVER_THUMB");
    ...
    my $cover_xhtml =
      ...
      . qq[</head>\n]
      . qq[<body>\n]
      . qq[    <p><img alt="$TITLE" src="../images/$COVER_THUMB" /></p>\n]
      . qq[</body>\n]
      . qq[</html>\n\n];
