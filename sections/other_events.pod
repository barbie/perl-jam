=head1 YAPCS, WORKSHOPS & HACKATHONS
...
places. They typically have a single focus, such as Perl 6, Parrot or Quality 
Assurance (QA), and are aimed at attracting more experienced programmers, with 
often a very high degree of technical input.

Both Workshops & Hackathons are a great way to learn how to put together a YAPC, 
as in many respects there are common organisational requirements (venue, 
accommodation, food, etc). However, it isn't necessary for you to have done 
something else before bidding for a YAPC, it just gives you some idea of what is 
involved.
