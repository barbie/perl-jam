...
of a YAPC Conference, some will also need convincing. Those who have either 
...
While small contributions are still valuable to you, yout focus should be on 
...
but are often have a sponsorship or marketing budget that they would use to make 
donations.
...
Remeber your website is likely to get a high Google ranking compared to their 
...
If you feel comfortable with it, may also allow larger corporate sponsors a time 
slot in your schedule to present a talk about themselves. As many attendees 
could potentially be turned off by a blatant market talk, encourage the sponsor 
too give a technical weighted talk about themselves or their product. Most of 
the attendees are developers, and do not make decisions for their company, but 
they may have influence in suggesting a particular company.

Some companies may wish to be involved in a Job Fair. Several YAPCs now feature 
this as way to encourage additional smaller sponsorship. Many international and 
nation business may wish to recruit IT developers, and you event may offer a 
great incentive to talk to several people atonce.

For large corporate sponsors you may also wish to provide free tickets to the 
event for their staff. Perhaps four places for top level sponsors and two places 
...
to a sponsor they will likely not feel that they are not going to get the 
...
monetary donations would expect to receive at each level. Provide a range rather 
than a specific amount, with the bottom value being the sum you would expect for 
that level of sponsorship. Some may pay more, but most will want to get the most 
for as minimum possible.

You also need to include details about who you are, and what the event means to 
...
look at the YAPC Conference Surveys and glean as much information as you can to 
support you.
...
promote your sponsorship opportunities. Use social netowrking sites to get the 
...
use Perl, but have never sponsored a YAPC before. Sometimes there might be a 
good reason for this, but it may also be because they have never been 
