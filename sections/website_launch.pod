...
conference. If the website looks a mess, it makes the employee's job much much 
harder to convince their boss why they should attend.
...
Maps are also useful. If you can, create a Google Map with pin-points to 
identify key places, such as the venue, hotels and transport points. In 
addition, you can include places to eat, drink and sightsee, as your attendees 
will appreciate these too. If you can find links to campus maps (if your venue 
is a educational establishment) or venue maps that identify the building in 
which you are hosting the event, include these as additional online links.
