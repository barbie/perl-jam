...
In addition there are now many social and micro-blogging networks available for 
you to get the word out. Signup to the following, and register a special 
conference account, if appropriate:
...
promotes YAPC events, and the admins are also willing to help promote workshops 
and large technical events too.
