...
attendees, have all helped to shape the YAPC story, whether they knew it or not!

Many thoughts and suggestions have been gleened from the YAPC Conference 
Surveys, which have now been running successfully for YAPC::Europe since 2006.

This book is intended to be a living document of how to organise a YAPC, so that 
it can grow with the lessons learnt and new ideas from future conferences. If 
you have any ideas and suggestions for improving the content, please contact 
Barbie (barbie@cpan.org) with details.
