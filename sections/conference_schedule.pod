...
little easier to whittle down your selection. 
...
impression on the attendees (hopefully it's be a good impression).
...
important information such as schedule changes. You finish each day will likely 
depend on when your venue closes. Some are accommodating and will let you stay 
late, allowing for BOFs at the venue, while others will charge overtime if you 
stay over your allotted hours. Don't try to cram too much into your schedule. If 
you don't have the time or the rooms, having 5 minutes between talks and 
starting at 8am is not a good solution.

=head2 Strategic Schedule Choices

Consider the following fixpoints for your schedule:
...
The dead for receiving papers or slides should be at minimum of a few days 
before you go to press, if you are having conference proceedings as a printed 
booklet. If you are only planning a CD version (or similar) this can be later, 
but you still need to give yourself to prepare the material and get it printed 
