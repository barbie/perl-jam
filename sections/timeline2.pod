=head1 CONFERENCE TIMELINE (PART 2) - THE FOUNDATIONS
...
Start working on your website, its the key promotional aid for yout event.

=item * Find Sponsors

Start approaching previous sponsors and any new big sponsors.
