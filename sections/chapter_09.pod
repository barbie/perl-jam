...
The following was created by the organisers of YAPC::NA 2011 N<Standards of 
Conduct - U<http://www.yapc2011.us/yn2011/conduct.html>>.

=over 4

=begin literal

B<Reasonable Person Principle>
...
=item * Everyone will be reasonable.

=item * Everyone expects everyone else to be reasonable.

=item * No one is special.

=item * Do not be offended if someone suggests you are not being reasonable.
