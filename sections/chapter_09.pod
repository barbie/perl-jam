...
After attending the first YAPC::Europe in 2000, in London, Barbie is now only 
one of a few who have attended every YAPC::Europe event since. After organising 
the 2006 YAPC::Europe Perl Conference, he decided to write down all the things 
that he felt future organisers should prepare themselves for. This book has been 
several years in the making, and will likely never be finished. But he says it 
has been fun :)

=head1 THE NAME

It may surprise you to know that Barbie is actually the author's real name. How 
the name Barbie came about is a long story, and may be if buy him a Guinness at 
a future conference, workshop or large technical event, he might tell you it. It 
might not be the true story, but it will be a long story ;)
...
kind. After Steve asked if anyone wanted the domain, perl-jam.info, it seemed to 
